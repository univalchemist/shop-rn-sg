...
/* CXA1 */
const fetchBenefitsSimplified = (clientId, userId, planYearId) =>
  getApi(
    Config.apiRoutes.fetchBenefitsSimplified(clientId, userId, planYearId),
  );

const getHospitalClinic = (clientId, claimtypeId) =>
  getApi(Config.apiRoutes.getHospitalClinic(clientId, claimtypeId));

const fetchEwallet = ({ clientId, userId }) =>
  getApi(Config.apiRoutes.fetchEwallet(clientId, userId));

const getClaimReasons = (clientId, claimTypeId) =>
  getApi(Config.apiRoutes.getClaimReasons(clientId, claimTypeId));
