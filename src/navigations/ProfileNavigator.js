...
import {
  ...
  CXA1ProfileMyBenefitsScreen,
  CXA1ProfilePlanYearModal,
  CXA1ProfileMemberModal,
...
const ProfileNavigator = ({ role, isCXA1Integration }) => {
  const intl = useIntl();
  ...
  return (
    ...
    >
      ...
      {isCXA1Integration && (
        <Stack.Screen
          name={PROFILE_PLAN_YEAR_MODAL}
          component={CXA1ProfilePlanYearModal}
          options={{
            title: intl.formatMessage({
      ...
      <Stack.Screen
        ...
        component={
          isCXA1Integration ? CXA1ProfileMemberModal : ProfileMemberModal
        }
        options={{
          title: intl.formatMessage({
