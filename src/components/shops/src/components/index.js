...
export { default as ShopHeader } from './Header';
export { default as Spinner } from './Spinner';
export { default as AddToCartButton } from './AddCartButton';
...
export { default as DeliverySelfCollection } from './DeliverySelfCollection';
export {
  BillingAddresses,
  ShippingAddresses,
  AddressForm,
