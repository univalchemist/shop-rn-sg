...
describe('localizeServerError', () => {
  ...
  describe('getLocalizeServerError', () => {
    it('should work properly', () => {
      ...
      expect(subject).toBe('error.Unauthorized');
      expect(message).toEqual('test.Unauthorized');
    });

    it('message key should return default when not yet define error', () => {
      const error = null;
