  ...
  return (
    <Box>
      ...
      <SecondaryText fontSize={14} mt={24}>
        {intl.formatMessage({ id: 'shop.address.firstName' })}
      </SecondaryText>
      <Text fontSize={14}>{firstName}</Text>
      <SecondaryText fontSize={14} mt={16}>
        {intl.formatMessage({ id: 'shop.address.lastName' })}
      </SecondaryText>
      <Text fontSize={14}>{lastName}</Text>
      <SecondaryText fontSize={14} mt={16}>
      ...
      <SecondaryText fontSize={14} mt={16}>
        {intl.formatMessage({ id: 'shop.address.telephone' })}
      </SecondaryText>
      <Text fontSize={14}>{telephone}</Text>
      <Box mt={32}>
        <TrackedButton
          secondary
