...
import { HEAL_DOCTOR_DETAIL, HEAL_UNIFY_SEARCH } from '@heal/routes';
...
describe('DoctorListingScreen', () => {
  ...
  test('render list item and able to navigate', async () => {
    ...
    expect(navigation.navigate).toBeCalledWith(HEAL_DOCTOR_DETAIL, {
      doctor: {
        id: 240,
        locale: 'en-HK',
        name: 'Anna Tan',
  ...
  test('able to navigate to other screens', async () => {
    ...
    expect(navigation.navigate).toBeCalledWith(HEAL_UNIFY_SEARCH);
  });
