      ...
      <Box backgroundColor={'rgba(0,0,0,0.32)'} as={SafeAreaView} flex={1}>
          ...
          <Box>
            ...
            >
              <PlainText color={theme.colors.gray[0]}>
                {intl.formatMessage({
                  id: 'heal.doctor.scheduleAppointment.pickDate',
                })}
              </PlainText>
            ...
            <ScrollView>
              ...
              <Box p={20}>
                <PlainText color={theme.colors.gray[0]}>
                  {intl.formatMessage({
                    id: 'heal.doctor.scheduleAppointment.pickTime',
                  })}
                </PlainText>
                <Box mt={10} flexDirection={'row'}>
                  <TouchableOpacity onPress={() => onPress('AM')}>
                    ...
                    >
                      ...
                      >
                        {intl.formatMessage({
                          id: 'heal.doctor.scheduleAppointment.time.am',
                        })}
                      </PlainText>
                    </Box>
                  </TouchableOpacity>
                  <TouchableOpacity onPress={() => onPress('PM')}>
                    ...
                    >
                      ...
                      >
                        {intl.formatMessage({
                          id: 'heal.doctor.scheduleAppointment.time.pm',
                        })}
                      </PlainText>
                    </Box>
                  </TouchableOpacity>
              ...
              {error && (
                <Box>
                  ...
                  >
                    {intl.formatMessage({
                      id: 'heal.doctor.scheduleAppointment.pickDate.error',
                    })}
                  </PlainText>
                </Box>
              )}
        ...
        <Button
          ...
          title={intl.formatMessage({
            id: 'heal.doctor.scheduleAppointment.confirmDate',
          })}
        />
      </Box>
    </Modal>
