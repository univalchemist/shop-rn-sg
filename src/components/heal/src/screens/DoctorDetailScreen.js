...
import { HEAL_SELECT_FAMILY_MEMBER } from '@heal/routes';
      ...
      >
        <View alignItems="center">
          ...
          <Box flexDirection="row" alignItems="center" mt={8}>
            ...
            >
              {doctor.isActive
                ? intl.formatMessage({ id: 'heal.available' })
                : intl.formatMessage({ id: 'heal.unavailable' })}
            </Text>
          </Box>
        </View>
        {!!doctor.introduction && (
  ...
  return (
    <Box flex={1} backgroundColor={theme.colors.backgroundColor}>
      ...
      >
        <Button
          primary
          title={intl.formatMessage({ id: 'heal.doctor.bookAppointment' })}
          onPress={() => {
