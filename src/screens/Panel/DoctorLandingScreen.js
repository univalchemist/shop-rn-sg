...
import { PANEL_SEARCH } from '@routes';
import {
  HEAL_UNIFY_SEARCH,
  HEAL_DOCTOR_LISTING,
        ...
        <Box px={32} pb={24}>
          ...
          >
            ...
            <Box flex={0.2} alignItems="center">
              <TouchableOpacity
                onPress={() => navigation.navigate(HEAL_SCAN_QR_CODE)}
              >
              ...
              specialists.map((specialist, index) => (
                <Box flexBasis={0.47} key={index}>
                  <SpecialistItem
                    {...specialist}
                    onPress={() => {
                      navigation.navigate(HEAL_DOCTOR_LISTING, {
          ...
          <Box pt={16} pb={24}>
            <Button
              ...
              onPress={() => navigation.navigate(HEAL_SPECIALITY_LISTING)}
            />
          </Box>
        </Box>
      </ScrollView>
