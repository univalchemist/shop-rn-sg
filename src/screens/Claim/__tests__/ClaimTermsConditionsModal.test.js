...
describe('ClaimTermsConditionsModal', () => {
  ...
  it('should navigate to CLAIM_ERROR_MODAL on uploadDocumentReference type:Receipt error', async () => {
  ...
  it('should navigate to CLAIM_ERROR_MODAL on uploadDocumentReference type:Referral error', async () => {
  ...
  it('should navigate to CLAIM_ERROR_MODAL on submitClaim error', async () => {
