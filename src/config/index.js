...
const CLAIM_SHARED_HOST = SHARED_HOST + '/claim';
...
const Config = {
  ...
  apiRoutes: {
    ...
    getClaim: (clientId, userId, claimId) =>
      `${CLAIM_SHARED_HOST}/api/v1/clients/${clientId}/users/${userId}/claims/${claimId}`,
    getClaims: (clientId, userId, filters = '') =>
      `${CLAIM_SHARED_HOST}/api/v1/clients/${clientId}/users/${userId}/claims?${filters}`,
    postClaims: (clientId, userId) =>
      `${CLAIM_SHARED_HOST}/api/v1/clients/${clientId}/users/${userId}/claims`,
    ...
    postUploadClaimDocument: (clientId, userId, type) =>
      `${CLAIM_SHARED_HOST}/api/v1/clients/${clientId}/users/${userId}/claim/documents/${type}`,
    ...
    getClaimTypes: clientId =>
      `${CLAIM_SHARED_HOST}/api/v1/clients/${clientId}/claimtypes`,
    getClaimFilters: clientId =>
      `${CLAIM_SHARED_HOST}/api/v1/clients/${clientId}/filters`,
    getBalance: (clientId, memberId) =>
      `${PAYMENT}/api/v1/clients/${clientId}/users/${memberId}/balance`,
    getHospitalClinic: (clientId, claimtypeId) =>
      `${CLAIM_SHARED_HOST}/api/v1/clients/${clientId}/claimtypes/${claimtypeId}/providers`,
    getClaimReasons: (clientId, claimTypeId) =>
      `${CLAIM_SHARED_HOST}/api/v1/clients/${clientId}/claimtypes/${claimTypeId}/claimreasons`,
    ...
    /* CXA1 */
    fetchBenefitsSimplified: (clientId, userId, planYearId) =>
      planYearId
        ? `${SHARED_HOST}/benefit/api/v1/clients/${clientId}/users/${userId}/Benefits-simplified?defaultPlanId=${planYearId}`
        : `${SHARED_HOST}/benefit/api/v1/clients/${clientId}/users/${userId}/Benefits-simplified`,

    fetchEwallet: (clientId, employeeId) =>
      `${WALLET_SHARED_HOST}/api/v1/clients/${clientId}/members/${employeeId}/balance?includeDependents=true`,
  },
};
